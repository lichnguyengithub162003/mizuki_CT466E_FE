...
export type ProductBackendSort =
  | "newest"
  | "price_asc"
  | "price_desc"
  | "rating"
...
export type ProductDetailStockState =
  | "available"
  | "low-stock"
  | "out-of-stock";
...
export interface ProductDetailQuestionAnswer {
  readonly id: string;
  readonly author?: string;
...
export interface ProductDetailQuestion {
  ...
  readonly date?: string;
  readonly answers: readonly ProductDetailQuestionAnswer[];
}
...
export interface ProductFamilyGroupOptionProduct {
...
export interface ProductFamilyGroupOption {
  readonly id: string;
  readonly label: string;
  readonly imageUrl?: string;
  readonly isDefault: boolean;
  readonly products: readonly ProductFamilyGroupOptionProduct[];
}
...
export interface ProductFamilyGroup {
  ...
  readonly options: readonly ProductFamilyGroupOption[];
}
...
export interface ProductDetail {
  ...
  readonly variantGroups: readonly ProductFamilyGroup[];
