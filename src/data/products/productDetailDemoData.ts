...
const productImages: readonly ProductDetailImage[] = [
  {
    id: "front",
    label: "Mặt trước",
    alt: "Bao bì mặt trước của sản phẩm",
    tone: "sage",
  },
  {
    id: "texture",
    label: "Kết cấu",
    alt: "Kết cấu gel trong nhẹ của sản phẩm",
    tone: "mint",
  },
  {
    id: "benefit",
    label: "Công dụng",
    alt: "Minh hoạ công dụng chính của sản phẩm",
    tone: "sand",
  },
  {
    id: "routine",
    label: "Chu trình",
    alt: "Sản phẩm trong chu trình chăm sóc da",
    tone: "rose",
  },
  {
    id: "packaging",
    label: "Bao bì",
    alt: "Chi tiết bao bì và vòi lấy sản phẩm",
    tone: "sky",
  },
];
      ...
      answers: [
        {
          id: "a1",
          author: "Mizuki",
          text: "Sản phẩm được thiết kế để dùng hằng ngày. Bạn nên thử trên vùng da nhỏ nếu đang trong liệu trình đặc biệt.",
          date: "2026-08-10",
        },
      ],
    },
      ...
      answers: [
        {
          id: "a2",
          author: "Mizuki",
          text: "Có thể dùng sau bước tẩy trang để hoàn thiện quy trình làm sạch kép vào cuối ngày.",
          date: "2026-08-10",
        },
      ],
    },
...
export function getProductDetailBySlug(
  ...
  const catalogProduct = productListingProducts.find(
  ...
  return {
    ...
    brand: {
      ...
      origin: "Pháp",
      description:
        "Thương hiệu chăm sóc cá nhân chú trọng công thức dịu nhẹ, minh bạch và trải nghiệm sử dụng hằng ngày.",
      rating: 4.8,
      reviewCount: 2_460,
      productCount: 128,
      isOfficial: true,
    ...
    discountLabel: catalogProduct.discountPercent
...
): readonly ProductListingProduct[] {
  return productListingProducts.filter((item) =>
